Sirv.define(
    'Video',
    ['bHelpers','magicJS','globalVariables','globalFunctions','helper','EventEmitter','Instance','defaultsVideoOptions'],
    (bHelpers,magicJS,globalVariables,globalFunctions,helper,EventEmitter,Instance,defaultsVideoOptions) => {
    ...
    class VideoInstance extends Instance {
        ...
        addSources() {
            ...
            Promise.all([
                ...
                loadVideoJS().then(loadQualitySelector)
            ]).finally(() => {
        ...
        get posterUrl() {
            ...
            if (!this.ready) {
                ...
                const posterImage = this.posterUrl;
