Sirv.define(
    'Zoom',
    ['bHelpers','magicJS','globalVariables','globalFunctions','helper','EventEmitter','Zoominstance','Hint','ResponsiveImage','RoundLoader','Hotspots'],
    (bHelpers,magicJS,globalVariables,globalFunctions,helper,EventEmitter,Zoominstance,Hint,ResponsiveImage,RoundLoader,Hotspots) => {
...
const Zoom = (() => {
    ...
    class Zoom_ extends Zoominstance {
        ...
        canIUseOutsideZoom() {
            ...
            if (this.insideOptions.type === 'outside') {
                if ([globalVariables.FULLSCREEN.OPENING, globalVariables.FULLSCREEN.OPENED].includes(this.fullscreenState)) { return result; }
        ...
        onZoomHidden(e) {
            ...
            if (this.hotspots) {
                if (
                    this.hotspotsTurnedOn && [globalVariables.FULLSCREEN.CLOSED, globalVariables.FULLSCREEN.OPENING].includes(this.fullscreenState) ||
                    this.insideOptions.trigger !== 'hover' && [globalVariables.FULLSCREEN.OPENED, globalVariables.FULLSCREEN.CLOSING].includes(this.fullscreenState)
                ) {
        ...
        onMouseAction(type) {
            if (type === 'mouseout') {
                if (
                    !['deep', 'magnifier'].includes(this.option('mode')) &&
                    (
        ...
        onResize() {
            ...
            if (this.isStarted && this.postInitState === 2) {
                ...
                if (this.hotspots) {
                    if (this.hotspotsTurnedOn && [globalVariables.FULLSCREEN.CLOSED, globalVariables.FULLSCREEN.OPENING].includes(this.fullscreenState) ||
                        this.insideOptions.trigger !== 'hover' && [globalVariables.FULLSCREEN.OPENED, globalVariables.FULLSCREEN.CLOSING].includes(this.fullscreenState)) {
                        this.hotspots.containerSize = this.imageNode.node.getBoundingClientRect();
                        if (this.isInView && this.isSlideShown) {
                            this.hotspots.showNeededElements();
