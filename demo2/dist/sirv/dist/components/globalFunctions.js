Sirv.define('globalFunctions', ['bHelpers', 'magicJS', 'globalVariables', 'helper', 'Promise!'], function (bHelpers, magicJS, globalVariables, helper, Promise) {
  ...
  var RootDOM = /*#__PURE__*/function () {
    ...
    var _proto = RootDOM.prototype;

    _proto.rootContains = function rootContains(node) {
    ...
    _proto.addModuleCSSByName = function addModuleCSSByName(moduleName, functionOfCssString, id, position) {
    ...
    _proto.getRootNode = function getRootNode(node
    /* Element which has 'Sirv' class name */
    ) {
      node = $(node).node;
    ...
    */
    ...
    _proto.attachNode = function attachNode(node
    /* Element which has 'Sirv' class name */
    ) {
      node = $(node).node;
    ...
    */
    ...
    _proto.detachNode = function detachNode(node
    /* Element which has 'Sirv' class name */
    ) {
      node = $(node).node;
    ...
    _proto.addCSSStringToHtml = function addCSSStringToHtml() {
      this.addCSSString($J.D.node.head || $J.D.node.body);
    };

    _proto.addCSSString = function addCSSString(node
    /* Element which has 'Sirv' class name */
    ) {
      var _this = this;
      ...
      helper.objEach(this.CSSMap, function (key, value) {
        if (!rootObject.modulesCss[key]) {
          ...
          helper.addCss(value.functionOfCssString(), value.id, value.position, shadowRoot, '#' + _this.mainCSSID);
        }
      });
    };

    _proto.addMainStyleToHtml = function addMainStyleToHtml() {
    ...
    _proto.addMainStyle = function addMainStyle(node
    /* Element which has 'Sirv' class name */
    ) {
    ...
    _proto.addStyle = function addStyle(node
    /* Element which has 'Sirv' class name */
    ...
    _proto.resetGlobalCSS = function resetGlobalCSS(node
    /* Element which has 'Sirv' class name */
    ) {
      if (!node) {
        node = $J.D.node.head || $J.D.node.body;
    ...
    _proto.showSirvAd = function showSirvAd(node
    /* Element which has 'Sirv' class name */
